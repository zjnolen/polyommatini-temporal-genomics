...
species <- c(
  "aagestis", "aoptilete", "cargiolus", "palcon",
  "pamandus", "pargyrognomon", "sorion"
)
genomes <- c(
  "ilAriAges2.1", "ilCyaSemi1.1", "ilCelArgi3.2",
  "ilPheArio1.1", "ilPolIcar1.1", "ilPleArgu1.3",
  "ilGlaAlex1.1"
)
```
...
plots[["full"]] + bgcolor("white")

ggsave("../figures/fig-specdiv.png", dpi = 600, create.dir = TRUE)
```

Since we have multiple depth subsamplings, these can be shown in a supplementary
figure.
