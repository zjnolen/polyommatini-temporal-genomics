...
rule vep_annotate_vars:
    input:
        bcf="results/datasets/{dataset}/bcfs/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.bcf",
        ref="results/ref/{ref}/{ref}.fa",
        gff="results/ref/{ref}/{ref}.gff.gz",
    output:
        out="results/datasets/{dataset}/analyses/vep/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.vep-annotated.txt",
        html="results/datasets/{dataset}/analyses/vep/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.vep-annotated.txt_summary.html",
        warnings="results/datasets/{dataset}/analyses/vep/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.vep-annotated.txt_warnings.txt",
    conda:
        "../envs/vep.yaml"
    resources:
        runtime="4d",
...
rule calc_vep_load:
    ...
    """
    input:
        vep="results/datasets/{dataset}/analyses/vep/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.vep-effects.txt",
        vars="results/datasets/{dataset}/bcfs/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.csv",
        samples="results/datasets/{dataset}/bcfs/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.samples",
        pops="results/datasets/{dataset}/poplists/{dataset}_all.indiv.list",
    output:
        rxy="results/datasets/{dataset}/analyses/vep/{dataset}.{ref}_all{dp}_{sites}-filts.filtered_mindp{mindp}-biallelic.notrans.fmiss{miss}.rxy.tsv",
